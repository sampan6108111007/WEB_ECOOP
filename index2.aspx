<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="Web_Admin.index2" %>
...
<head runat="server">
  ...
  <title>สหกรณ์ออมทรัพย์ครู ลำปาง จำกัด</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index2.aspx" class="nav-link">Home</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-1 pb-1 mb-1 d-flex">
          <img src="https://user-images.githubusercontent.com/45837589/96421682-3f4a8080-1221-11eb-9dfb-d5614f354ebf.jpeg" alt="User Image" style="height:30px;">
        <div class="info">
          <a href="https://github.com/sampan6108111007?tab=repositories">Sampan Suriya</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://www.youtube.com/channel/UCfapp5DYa0jRIFlrLsrmLXw?view_as=subscriber" class="nav-link">
...
<fieldset class="col-12 small-box" style="font-family:kanit;float:left;"><legend><b>MAIN</b></legend>

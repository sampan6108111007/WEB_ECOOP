<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Web_Admin.Index" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active"><a class="nav-link" href="index.html"><i class="fas fa-fw fa-tachometer-alt">
  ...
  <a class="navbar-brand" href="#">
    <img src="/img/logo2.gif" width="100%" height="100%" class="d-inline-block align-top" alt="">
  </a>
